...
//  TemplateImageApp
//
//  Created by Amit Gupta on 3/2/22.
//
...
let diagText=["Dogs":"Cute dog","Cats":"Nice cat"]
let diagImage=["Dogs":"image_xray","Cats":"image_xray"]
let diagPara=["Dogs":paraDogs,"Cats":paraCats]
...
struct ContentView: View {
    ...
    @State private var inputImage: UIImage? = UIImage(named: "image_xray")
